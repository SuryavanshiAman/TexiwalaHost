...
class Ridemapping extends StatefulWidget {
  // final String locationType;

  @override
  State<Ridemapping> createState() => _RidemappingState();
}

class _RidemappingState extends State<Ridemapping> {
                  ...
                  child:Column(
                    children: [
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text('Pick Up',style: robotoBlack,),
                                 ...
                                 child: Center(child: Text('2.3 kms',style: robotoBold,)),
                                  ),
                                ],
                              ),
                              SizedBox(height: height*0.01,),
                              Text('Saibabaa Kovil,Coimbatore            \n,TamilNadu,India',style: robotoMediumBlack,)
                            ],
                          ),
                        ),
                      ),
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text('Drop',style: robotoBlack,),
                              ),
                              SizedBox(height: height*0.01,),
                              Text('23,VSC Nagar,Thudilur,TamilNadu\n,India',style: robotoMediumBlack,)
                            ],
                          ),
                        ),
                      ),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: [
                        Text('Totaol Fare',style: robotoMediumBlack,),
                        Text('₹5000.00',style: robotoMediumBlack,)
                      ],
                      ),
                      SizedBox(height: height*0.02,),
                      Row(
                        ...
                        children: [
                         InkWell(
                           onTap: (){
                             Navigator.pushNamed(context, RoutesName.Customerpickup);
                           },
                           child: Container(
                             height: height*0.06,
                             width: width*0.35,
                          ...
                          Container(
                            ...
                            child: Center(child:Text('Pass',style: robotoMediumBlack,)),
                          ),
                        ],
                      ),
                    ],
