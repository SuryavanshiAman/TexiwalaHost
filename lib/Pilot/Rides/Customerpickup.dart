...
class Customerpickup extends StatefulWidget {
  // final String locationType;

  @override
  State<Customerpickup> createState() => _CustomerpickupState();
}

class _CustomerpickupState extends State<Customerpickup> {
                ...
                return Container(
                  ...
                  child:Column(
                   ...
                   SizedBox(height: height*0.02,),
                     ...
                     InkWell(
                       onTap: (){
                         Navigator.pushNamed(context, RoutesName.RideCondfirmation);
                       },
                       child: Container(
                         height: height*0.076,
                         width: width*1.0,
                         ...
                         child:Row(
                           ...
                           children: [
                            Text('Location arrived  ',style: robotoMediumExtraWhite,),
