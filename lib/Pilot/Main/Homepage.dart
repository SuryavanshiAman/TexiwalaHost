    ...
    return Positioned(
      ...
      child: Container(
        ...
        child: AnotherStepper(
          stepperList: Bookdata.getStepperListMap(context),
              ...
              builder: (BuildContext context,
                ...
                return Container(
                  ...
                  child:Column(
                    ...
                    Text('     Clean your car',style: robotoMediumBlack,),
                      SizedBox(height: height*0.02,),
                      Text('       You must santize and clean your car\n       after every ride',style: robotoBlack,),
                      SizedBox(height: height*0.02,),
                      Center(child: ColorButton(onTap: () {
                        Navigator.pushNamed(context, RoutesName.Ridemapping);
                      }, text: 'Ok', btnColor:ColorConstant.Black_COLOR, textColor:ColorConstant.WHITE_COL0R,)),
                      SizedBox(height: height*0.02,),
                      Center(
                        child: Container(
                          height: height*0.15,
                          ...
                          child:Column(
                            children: [
                             ...
                             Row(
                               ...
                               children: [
                                 Text('1 Ride',style: robotoMediumBlack),
                                 Text('                                  ₹5000.00',style: robotoMediumBlack.copyWith(color: Colors.indigo),),
                                 Icon(Icons.arrow_right,color: Colors.indigo,size: 29,)
                               ],
                             ),
                              Divider(),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text('2 Incentives',style: robotoMediumBlack,),
                                  Text('                          ₹720.00',style: robotoMediumBlack.copyWith(color: Colors.indigo),),
                                  Icon(Icons.arrow_right,color: Colors.indigo,size: 29,)
                                ],
                              ),
                            ],
